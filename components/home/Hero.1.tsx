        ...
        <div className="max-w-[85rem] mb-20 mt-28 px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
            <div className="lg:col-span-3">
              ...
              <p className="mt-10">
                Edenia, incarne trois principes fondamentaux : la durabilité, la
                certification biologique et écologique, ainsi qu'un engagement
                profond envers nos communautés locales.La durabilité est au cœur
                de tout ce que nous faisons chez Edenia.
              </p>
              ...
              <div>
                ...
                <div className="p-5">
                  ...
                  <p className="mt-4 text-base text-gray-600 dark:text-gray-200">
                    ...
                    comme engagement envers la préservation de l'environnement.
                  </p>
                </div>
              </div>
            </div>
