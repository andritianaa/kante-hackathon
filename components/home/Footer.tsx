export const Footer = () => {
    return (
        <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto border">
            <div className="text-center">
                ...
                <div className="mt-3">
                    <p className="text-gray-500 dark:text-neutral-500">We're part of the <a className="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400" href="#">Unknown</a> family.</p>
                    <p className="text-gray-500 dark:text-neutral-500">© Kante Co. 2024 Unknown. All rights reserved.</p>
                </div>
